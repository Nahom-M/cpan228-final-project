...
public class DataInitializer {
    ...
    public CommandLineRunner initData() {
        return args -> {
            // Step 1: Create distribution centres with mutable lists
            DistributionCentre toronto = new DistributionCentre(null, "Toronto", 43.65, -79.34, new ArrayList<>());
            DistributionCentre vancouver = new DistributionCentre(null, "Vancouver", 49.28, -123.12, new ArrayList<>());
            DistributionCentre montreal = new DistributionCentre(null, "Montreal", 45.50, -73.56, new ArrayList<>());
            DistributionCentre ottawa = new DistributionCentre(null, "Ottawa", 45.42, -75.69, new ArrayList<>());

            centreRepo.saveAll(Arrays.asList(toronto, vancouver, montreal, ottawa));

            // Step 2: Create items with mutable stock lists
